...
# https://www.w3schools.com/python/ref_func_chr.asp : The chr() I used
# https://www.w3schools.com/python/ref_func_ord.asp : The ord() I used
...
for letter in Alphabet: 
    ...
    for char in random_string:
        if letter == char:
            num = num + 1
    Occurence_Dict[letter] = num
print(Occurence_Dict)

print("*"*75)

# Output which letter occurred the most 
bucket_big = Occurence_Dict["a"]
bucket_small = Occurence_Dict["a"]
for letter in Occurence_Dict:
    Percentage_Dict[letter] = f"{((Occurence_Dict[letter])/len(random_string))*100}%"
    if Occurence_Dict[letter] < bucket_small:
        bucket_small = Occurence_Dict[letter]
    if Occurence_Dict[letter] > bucket_big:
        bucket_big = Occurence_Dict[letter]

most_occurred = bucket_big
least_occurred = bucket_small
